...
public class Prueba {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
                "Tu cambio, no te lo daremos, es MaxMad, pero te habrían sobrado: " + dinero_inicial.getValor());
    ...
    private static Coche menuPersonalizado(ReferenciaNumeroDoble dineroInicial) {
        ...
        llanta = FabricaLlanta.catalogo[seleccion];
        System.out.println("Te quedan: "+dineroInicial.getValor());
        ...
        dineroInicial.restar(componenteSeleccionado.getCosto());
        motor = FabricaMotor.catalogo[seleccion];
        System.out.println("Te quedan: "+dineroInicial.getValor());
        /* Creamos el coche */
    ...
    private static Coche menuPredifinido(ReferenciaNumeroDoble dineroInicial) {
        ...
        System.out.println(dineroInicial.getValor());
